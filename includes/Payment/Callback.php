...
//                    return '<b style="color:#8BC34A;">' . $this->filled_message( $value['success_message'], $row->track_id, $row->order_id ) . '</b>';
//                }
//            }
//
//            if ( $status != 10 ) {
...
//				);
//
//                return '<b style="color:#f44336;">' . $this->filled_message( $value['failed_message'], $track_id, $order_id ) . '</b>';
//            }
//
...
//				);
//
//                return '<b style="color:#f44336;">' . $this->filled_message( $value['failed_message'], $verify_track_id, $verify_order_id ) . '</b>';
//            } else {
//                $wpdb->update( $wpdb->prefix . 'cf7_transactions',
//					array(
//						'status'   => 'completed',
...
//				);
//
//                return '<b style="color:#8BC34A;">' . $this->filled_message( $value['success_message'], $verify_track_id, $verify_order_id ) . '</b>';
//            }
//        } else {
...
//    }
     ...
     * @return string
     */
    private function filled_message( $message, $track_id, $order_id ) {
